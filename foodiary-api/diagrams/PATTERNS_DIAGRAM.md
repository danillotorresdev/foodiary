...
```mermaid
%%{init: {'themeVariables': { 'primaryTextColor': '#212121', 'darkMode': false }}}%%
mindmap
...
flowchart LR
  subgraph CLIENT["<b>Cliente (App Mobile)</b>"]
    REQ_W["POST / PUT<br/><i>Escrita</i>"]
    REQ_R["GET<br/><i>Leitura</i>"]
  end

  subgraph APIGW["<b>API Gateway</b>"]
  ...
  subgraph COMMAND_SIDE["<b>Command Side (Escrita)</b>"]
    direction TB
    CTRL_C["Controller"]
    UC["UseCase"]
    REPO_C["Repository"]
  ...
  subgraph QUERY_SIDE["<b>Query Side (Leitura)</b>"]
    direction TB
    CTRL_Q["Controller"]
    QRY["Query"]
    DTO["DTO direto"]
  ...
  subgraph DB["<b>DynamoDB (MainTable)</b>"]
    TABLE["PK/SK + GSI1"]
  end
  ...
  style COMMAND_SIDE fill:#fff3e0,stroke:#e65100,color:#212121
  style QUERY_SIDE fill:#e3f2fd,stroke:#1565c0,color:#212121
  style DB fill:#e8f5e9,stroke:#2e7d32,color:#212121
  style CLIENT fill:#e1f5fe,stroke:#0277bd,color:#212121
  style APIGW fill:#e3f2fd,stroke:#1565c0,color:#212121
```
...
flowchart TB
  ...
  style TRIGGERS fill:#e3f2fd,stroke:#1565c0,color:#212121
  style ADAPTERS fill:#fff3e0,stroke:#e65100,color:#212121
  style APP fill:#e8f5e9,stroke:#2e7d32,color:#212121
```
...
flowchart TB
  ...
  style REG fill:#f3e5f5,stroke:#6a1b9a,color:#212121
  style SC fill:#e3f2fd,stroke:#1565c0,color:#212121
  style SUC fill:#e8f5e9,stroke:#2e7d32,color:#212121
  style AG fill:#fff3e0,stroke:#e65100,color:#212121
  style AR fill:#fff3e0,stroke:#e65100,color:#212121
  style UOW fill:#fff3e0,stroke:#e65100,color:#212121
```
...
%%{init: {'themeVariables': { 'primaryTextColor': '#212121' }}}%%
flowchart TB
  subgraph BASE["<b>Controller (classe abstrata)</b>"]
    EX["execute(request)"]
  ...
  subgraph SUB1["<b>SignUpController</b>"]
    H1["handle()<br/>→ signUpUseCase.execute()"]
  end

  subgraph SUB2["<b>CreateMealController</b>"]
    H2["handle()<br/>→ createMealUseCase.execute()"]
  end

  subgraph SUB3["<b>GetMeController</b>"]
  ...
  style BASE fill:#f3e5f5,stroke:#6a1b9a,color:#212121
  style SUB1 fill:#e8f5e9,stroke:#2e7d32,color:#212121
  style SUB2 fill:#e8f5e9,stroke:#2e7d32,color:#212121
  style SUB3 fill:#e8f5e9,stroke:#2e7d32,color:#212121
```
...
flowchart LR
  ...
  subgraph MAPPER["<b>MealItem (Data Mapper)</b>"]
  ...
  subgraph DYNAMO["<b>DynamoDB Item</b>"]
  ...
  style DOMAIN fill:#e8f5e9,stroke:#2e7d32,color:#212121
  style MAPPER fill:#fff3e0,stroke:#e65100,color:#212121
  style DYNAMO fill:#e3f2fd,stroke:#1565c0,color:#212121
```
...
flowchart TB
  ...
  subgraph HANDLER["<b>lambdaHttpAdapter catch</b>"]
  ...
  style ZOD fill:#fff9c4,stroke:#f9a825,color:#212121
  style HTTP fill:#ffccbc,stroke:#bf360c,color:#212121
  style APP fill:#ffccbc,stroke:#bf360c,color:#212121
  style UNK fill:#ef9a9a,stroke:#b71c1c,color:#212121
  style HANDLER fill:#e0e0e0,stroke:#424242,color:#212121
```
...
flowchart TB
  ...
  subgraph PIC_FLOW_DETAIL["<b>Estrategia: PICTURE</b>"]
  ...
  subgraph AUD_FLOW_DETAIL["<b>Estrategia: AUDIO</b>"]
  ...
  style PIC_FLOW_DETAIL fill:#e3f2fd,stroke:#1565c0,color:#212121
  style AUD_FLOW_DETAIL fill:#fff3e0,stroke:#e65100,color:#212121
  style RESULT fill:#e8f5e9,stroke:#2e7d32,color:#212121
```
